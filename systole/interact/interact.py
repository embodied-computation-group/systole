...
class Viewer:
    ...
    preprocessed_folder : str | PathLike
...
class Editor:
    ...
    corrected_peaks : np.ndarray | None
    ...
    time : np.ndarray
        Time vector.
    edition_, rejection_, command_box_, save_button_ : widgets
